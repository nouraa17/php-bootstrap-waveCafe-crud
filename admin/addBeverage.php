...
if (isset($_POST['add'])) {
	...
	$drink_name = $_POST['title'];
	$drink_img = addslashes(file_get_contents($_FILES['image']['tmp_name']));
	$drink_description = $_POST['description'];
	$drink_price = $_POST['price'];

	$sql = "INSERT INTO drink_menu (category_name,drink_name,drink_img,drink_description,drink_price)
VALUES('$category_name','$drink_name','$drink_img','$drink_description','$drink_price')";
	$conn->exec($sql);
	$msg = "<h4>Drink Added Successfully</h4>";
}
//////////////////////////////////////////////////////////////////////////////////////
...
<head>
	...
	<title>Wave Cafe Admin | Add Beverage</title>
			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="addBeverage.php" class="site_title"><i class="fa fa-user"></i> <span>Wave Cafe
								Admin</span></a>
					</div>
