...
<head>
  ...
  <title>Wave Cafe Admin | Categories</title>
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="categories.php" class="site_title"><i class="fa fa-user"></i></i> <span>Wave Cafe
                Admin</span></a>
          </div>
                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <td><a href='./editCategory.php?id={$category['category_name']}'><img src='./images/edit.png' alt='Edit'></a></td>
                          <td><a href='./deleteCategory.php?id={$category['category_name']}'><img src='./images/delete.png' alt='Edit'></a></td>
                        </tr>";
                            }
                            ?>
                          </tbody>
