...
$stmt = $conn->prepare("SELECT * FROM categories WHERE category_name = :category_name");
$stmt->bindParam(':category_name', $id, PDO::PARAM_STR);
$stmt->execute();
...
SET category_name='$c_name' WHERE category_name = '$id'";
...
<head>
	...
	<title>Wave Cafe Admin | Edit Category</title>
			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="editCategory.php" class="site_title"><i class="fa fa-user"></i> <span>Wave Cafe
								Admin</span></a>
					</div>
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align"
												for="add-category">Edit Category <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" required="required"
													class="form-control" value="<?php echo $cname; ?>" name="c_name">
											</div>
										</div>
