...
VALUES('$c_name')";
	$conn->exec($sql);
	$msg = "<h4>Category Added Successfully</h4>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
	...
	<title>Wave Cafe Admin | Add Category</title>
			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="addCategory.php" class="site_title"><i class="fa fa-user"></i> <span>Wave Cafe
								Admin</span></a>
					</div>
									...
									<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" id="demo-form2"
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align"
												for="add-category">Add Category <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input name="c_name" type="text" id="add-category" required="required"
													class="form-control ">
											</div>
										</div>
