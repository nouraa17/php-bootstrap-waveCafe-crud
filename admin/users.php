...
<head>
  ...
  <title>Wave Cafe Admin | Users</title>
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="users.php" class="site_title"><i class="fa fa-user"></i></i> <span>Wave Cafe
                Admin</span></a>
          </div>
                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <td>{$user['email']}</td>
                          <td>{$user['active']}</td>
                          <td><a href='./edituser.php?id={$user['user_id']}'><img src='./images/edit.png' alt='Edit'></a></td>
                          <td><a href='./deleteUser.php?id={$user['user_id']}'><img src='./images/delete.png' alt='Edit'></a></td>
                        </tr>";
                            }
                            ?>
