...
foreach ($user_data as $data) {
	$ufname = $data['full_name'];
	$uuname = $data['username'];
	$uemail = $data['email'];
	$uactive = $data['active'];
...
if (isset($_POST['update'])) {
	...
	$sql = "UPDATE users
SET full_name='$full_name',username='$username', email='$email',active='$active',password='$password'
WHERE user_id=$id";
...
<head>
	...
	<title>Wave Cafe Admin | Edit User</title>
			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="edituser.php" class="site_title"><i class="fa fa-user"></i> <span>Wave Cafe
								Admin</span></a>
					</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required"
													class="form-control " value="<?php echo $ufname; ?>"
													name="full_name">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="user-name" name="username" required="required"
													class="form-control" value="<?php echo $uuname; ?>">
											</div>
										</div>
										<div class="item form-group">
											<label for="email"
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="email" class="form-control" type="email" name="email"
													required="required" value="<?php echo $uemail; ?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" <?php echo ($uactive == 'Yes') ? 'checked' : ''; ?> name="active" value="on">
												</label>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="password" id="password" name="password" required="required"
													class="form-control" value="<?php echo $upassword; ?>">
											</div>
										</div>
